...
namespace RTSPathingLib {
  ...
  private:
    ...
    std::vector<Body>                          recurse( const glm::dvec2& parentCenter, size_t parentSize, double parentRotation, const Formation&);
    ...
    glm::dmat4                                 getLocalTransformation(const Formation&, const glm::dvec2& parentCenter, size_t parentScale, double& parentRotation, size_t scale);
