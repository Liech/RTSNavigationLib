...
namespace RTSPathingLib {
  ...
  private:
    ...
    static std::vector<Body>                          formate(std::map<size_t, std::map<size_t, size_t>>& current, const std::map<size_t, std::map<size_t, size_t>>& overall, glm::dmat4& transformation, const Formation&, std::vector<std::vector<glm::dvec2>>& allPolygons, bool& bigEnough);
